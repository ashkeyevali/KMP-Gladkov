...
fun JFrame.setupThemedNavigation() {
    val rootController = RootComposeBuilder().apply { generateGraph(source = NavigationSource.Desktop) }.build()
    ...
    composePanel.setContent {
        CompositionLocalProvider(
            ...
            AppTheme {
                val backgroundColor = theme.Theme.colors.primaryBackground
                rootController.backgroundColor = backgroundColor

                ModalNavigator(
                    DefaultModalConfiguration(
                        backgroundColor = backgroundColor,
                    displayType = ru.alexgladkov.odyssey.core.configuration.DisplayType.EdgeToEdge)) {
